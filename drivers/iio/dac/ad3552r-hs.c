...
static int ad3552r_hs_set_qspi(struct ad3552r_hs_state *st)
{
	//st->reset_gpio = devm_gpiod_get_optional(st->dev,
	return 0;
}
...
static int ad3552r_hs_setup(struct ad3552r_hs_state *st)
{
	...
	/*
	 * All the ad35xxr famili DACs are is in standard SPI after reset.
	 */
	ret = st->data->bus_set_io_mode(st->back, AD3552R_IO_MODE_QSPI);
	if (ret)
		return ret;
